...
--theme.wallpaper = "~/.config/awesome/themes/default/awesome-wallpaper.png"
...
theme.layout_uselesspiral = theme.lain_icons .. "cascadebrowsew.png"
...
--                n.background(beautiful.widget_bg)
            end
        else
 ...
 --   if s == 1 then right_layout:add(wibox.widget.systray()) end
    ...
    right_layout_add(alsamargin, alsawidget)
...
-- User Added Keybindings
 ...
 awful.key({modkey,           }, "g", function () 
    theme.useless_gap_width = theme.useless_gap_width + 10 
    awful.layout.inc(layouts,  1)
    awful.layout.inc(layouts, -1)
 end),
 awful.key({modkey, "Shift"   }, "g", function () 
    if theme.useless_gap_width > 9 then
        theme.useless_gap_width = theme.useless_gap_width - 10 
        awful.layout.inc(layouts,  1)
        awful.layout.inc(layouts, -1)
    end
 ...
 awful.key({modkey, "Shift"   }, "b", function() 
     cur_brightness = cur_brightness - 0.05
     awful.util.spawn("xrandr --output HDMI-0 --brightness " .. cur_brightness) 
 end),
 awful.key({modkey,           }, "b", function() 
     cur_brightness = cur_brightness + 0.05
     awful.util.spawn("xrandr --output HDMI-0 --brightness " .. cur_brightness)
 end),
 awful.key({modkey, "Control" }, "Escape", function () awful.util.spawn("xscreensaver-command -lock") end)
)
...
globalkeys = awful.util.table.join(globalkeys, awful.key({ }, "XF86AudioMute", function()
    ...
    -- The 2 following lines were needed at least on my
    -- configuration, otherwise it would get stuck muted
    -- --awful.util.spawn("amixer sset " ..
    -- "Speaker" .. " unmute")
    -- --awful.util.spawn("amixer sset " ..
    -- "Headphone" .. " unmute")
    vicious.force({ alsawidget.bar })
